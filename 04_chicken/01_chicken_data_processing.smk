...
raw_reads_dir = os.path.join(main_dir, "04_chicken/raw_reads")
trimmed_reads_dir = os.path.join(main_dir, "04_chicken/trimmed_reads")
mapped_reads_dir = os.path.join(main_dir, "04_chicken/mapped_reads")
