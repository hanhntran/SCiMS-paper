...
# ----- CONFIGURE -----
# Point this to the PREFIX of pre-built Bowtie2 index
BT2_INDEX="./reference_genome/GRCh38_latest_genomic.fna" 

# Define where mixed FASTQ files are located
INPUT_DIR="cami_mixed_reads"

MAPPED_DIR="mapped_cami"
MAX_JOBS=4   
THREADS=3
# ----- END CONFIG -----
